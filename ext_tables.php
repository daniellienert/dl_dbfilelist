...
$tmp_dl_dbfilelist_columns = array(
	...
	'title' => array(
		'exclude' => 0,
		'label' => 'LLL:EXT:dl_dbfilelist/Resources/Private/Language/locallang_db.xml:tx_dldbfilelist_domain_model_files.title',
		'config' => array(
			'type' => 'input',
			'size' => 30,
			'eval' => 'trim'
	...
	'description' => array(
		'exclude' => 0,
		'label' => 'LLL:EXT:dl_dbfilelist/Resources/Private/Language/locallang_db.xml:tx_dldbfilelist_domain_model_files.description',
		'config' => array(
			'type' => 'input',
			'size' => 30,
			'eval' => 'trim'
...
$TCA['tx_dldropboxsync_domain_model_filemeta']['types']['Tx_DlDbfilelist_Files']['showitem'] .= 'title, description, downloads';
