...
/**
 * Test case for class Tx_Dl_dbfilelist_Controller_FilesController.
 *
 * @version $Id$
 ...
 */
class Tx_Dl_dbfilelist_Controller_FilesControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
